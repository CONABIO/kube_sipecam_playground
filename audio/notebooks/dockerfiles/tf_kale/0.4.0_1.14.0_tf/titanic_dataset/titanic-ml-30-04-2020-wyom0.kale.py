...
def loaddata(vol_shared_volume: str):
...
def decisiontree(vol_shared_volume: str):
...
def naivebayes(vol_shared_volume: str):
...
def logisticregression(vol_shared_volume: str):
...
def results(vol_shared_volume: str):
...
@dsl.pipeline(
    name='titanic-ml-30-04-2020-wyom0',
...
if __name__ == "__main__":
    ...
    run_name = 'titanic-ml-30-04-2020-wyom0_run'
