...
def loaddata(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def datapreprocessing(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def featureengineering(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def decisiontree(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def svm(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def naivebayes(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def logisticregression(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def randomforest(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
def results(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020: str):
...
loaddata_op = comp.func_to_container_op(
    loaddata, base_image='sipecam/audio-kale:0.4.0_2.1.0')


datapreprocessing_op = comp.func_to_container_op(
    datapreprocessing, base_image='sipecam/audio-kale:0.4.0_2.1.0')


featureengineering_op = comp.func_to_container_op(
    featureengineering, base_image='sipecam/audio-kale:0.4.0_2.1.0')


decisiontree_op = comp.func_to_container_op(
    decisiontree, base_image='sipecam/audio-kale:0.4.0_2.1.0')


svm_op = comp.func_to_container_op(
    svm, base_image='sipecam/audio-kale:0.4.0_2.1.0')


naivebayes_op = comp.func_to_container_op(
    naivebayes, base_image='sipecam/audio-kale:0.4.0_2.1.0')


logisticregression_op = comp.func_to_container_op(
    logisticregression, base_image='sipecam/audio-kale:0.4.0_2.1.0')


randomforest_op = comp.func_to_container_op(
    randomforest, base_image='sipecam/audio-kale:0.4.0_2.1.0')


results_op = comp.func_to_container_op(
    results, base_image='sipecam/audio-kale:0.4.0_2.1.0')


@dsl.pipeline(
    name='titanic-ml-qmn2n',
    description='Predict which passengers survived the Titanic shipwreck'
)
def auto_generated_pipeline(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020='titanic'):
    pvolumes_dict = OrderedDict()

    annotations = {}

    #volume = dsl.PipelineVolume(
    #    pvc=vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)
    
    pvc_source = k8s_client.V1PersistentVolumeClaimVolumeSource(claim_name='efs')
    volume = k8s_client.V1Volume(name='efs-pvc', 
                                 persistent_volume_claim=pvc_source)

    #pvolumes_dict['/shared_volume/datasets_for_notebooks/titanic'] = volume

    volume_mount = k8s_client.V1VolumeMount(mount_path='/shared_volume',
                                            name='efs-pvc')
    ...
    #    size="1Gi"
    #)
    #pvolumes_dict['/marshal'] = volume_mount

    loaddata_task = loaddata_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
        .after()
        #.add_volume(pvolumes_dict['/shared_volume/datasets_for_notebooks/titanic_28_04_2020'])\
        #.add_volume_mount(pvolumes_dict['/marshal'])

    loaddata_task.container.working_dir = "/shared_volume/notebooks"
    loaddata_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))

    datapreprocessing_task = datapreprocessing_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
        .after(loaddata_task)
    ...
    datapreprocessing_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))
#
    featureengineering_task = featureengineering_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
    ...
    featureengineering_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))
#
    decisiontree_task = decisiontree_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
    ...
    decisiontree_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))
#
    svm_task = svm_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
        .after(featureengineering_task)
    ...
    svm_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))
#
    naivebayes_task = naivebayes_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
        .after(featureengineering_task)
    ...
    naivebayes_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))
#
    logisticregression_task = logisticregression_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
        .after(featureengineering_task)
    ...
    logisticregression_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))
#
    randomforest_task = randomforest_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
        .after(featureengineering_task)
    ...
    randomforest_task.container.set_security_context(
        k8s_client.V1SecurityContext(run_as_user=0))
#
    results_task = results_op(vol_shared_volume_datasets_for_notebooks_titanic_28_04_2020)\
        .add_volume(volume)\
        .add_volume_mount(volume_mount)\
...
if __name__ == "__main__":
    ...
    import kfp
    client = kfp.Client()
    experiment = client.create_experiment('titanic-kale')

    # Submit a pipeline run
    run_name = 'titanic-ml-qmn2n_run-9'
